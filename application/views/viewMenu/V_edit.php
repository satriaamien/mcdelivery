...
<body>
	...
	<div id="product-configurator" class="configurator"><div>
		<div class="configurator-header">
			<div class="container">
				<div class="row">
					<div class="quantity"><span class="added-quantity">0 </span>JUMLAH</span></div>
					<img src="<?php echo base_url('assets/foto/menu').$dataMenu["gambar"].'.png' ?>" alt="">
		...
		<form action=" <?php echo base_url('Menu/ubah_cart'); ?>" method="post">
										...
										<tbody><tr>
											<td class="controls-column">
												<div class="input-group item-quantity item-quantity-picker">
													<input type="number" name="qty" min="0" max="9" class="form-control" maxlength="1">
												</div>
											</td>
											...
											<td class="cost-column">Rp. <?php echo $dataMenu['price']; ?></td>
										</tr>
									</tbody>
								</table>
							</div></div>
			...
			<div class="container">
				<div class="media">
					...
					<div class="media-right text-center">
						...
						<input type="hidden" name="rowid" value="<?php echo $dataMenu["rowid"]; ?>" />
						<input type="hidden" name="nama" value="<?php echo $dataMenu["nama"]; ?>" />
						<input type="hidden" name="harga" value="<?php echo $dataMenu["price"]; ?>" />
